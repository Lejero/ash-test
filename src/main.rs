...
mod vk_assist;
use vk_assist::types::{
    vulkan_device, vulkan_device::VulkanDevice, vulkan_surface, vulkan_surface::VulkanSurface,
    vulkan_swap_chain, vulkan_swap_chain::ImageSize, vulkan_swap_chain::VulkanSwapChain,
};
...
impl VulkanApp {
    ...
    fn recreate_swapchain(&mut self) {
        ...
        let surface_suff = SurfaceStuff {
            surface_loader: self.vulkan_surface.surface_loader.clone(),
    ...
    fn cleanup_swapchain(&self) {
        unsafe {
            ...
            self.vulkan_swap_chain
                .swapchain_loader
                .destroy_swapchain(self.vulkan_swap_chain.swapchain, None);
        }
    }
}
