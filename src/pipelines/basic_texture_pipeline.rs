...
pub fn create_graphics_pipeline(
    ...
    let vert_shader_module = share::create_shader_module(&device.logical_device, include_bytes!("../../shaders/texture.vert.spv").to_vec());
    let frag_shader_module = share::create_shader_module(&device.logical_device, include_bytes!("../../shaders/texture.frag.spv").to_vec());
